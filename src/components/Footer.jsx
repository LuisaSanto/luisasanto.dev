...
const Footer = () => {
  return (
    ...
    >
      <div className="flex items-center justify-between w-full max-w-6xl px-5">
        <div className="text-secondary flex items-center space-x-2 text-[14px]">
          <span>Made with 🩵 by</span>
          <Link href="https://www.linkedin.com/in/luisa-santo/" target="_blank">
            <span className="text-white hover:underline font-semibold">luisasanto</span>
          </Link>
        </div>
        ...
        <div>
          <Link href="https://www.linkedin.com/in/luisa-santo/" target="_blank">
            <div className="text-white border border-gray-700 hover:border-gray-500 rounded-full px-3 py-1 transition-all hover:shadow-lg flex items-center">
